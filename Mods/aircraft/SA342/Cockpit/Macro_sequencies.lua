...
--{time = add_time(std_dt),device = devices.NAVLIGHTS,action = device_commands.Button_1,value = 0.0,message = _("NAV LIGHTS - OFF"),message_timeout = std_message},	
--{time = add_time(std_dt),device = devices.NAVLIGHTS,action = device_commands.Button_2,value = 0.0,message = _("ANTICOLLISION LIGHTS - OFF"),message_timeout = std_message},	
