...
function AutoStartSelection ($airframes, $installPath) {
  ...
  $SelectAllButton.Location = '15,225'
  ...
  $UnselectAllButton.Location = '15,255'
  ...
  $uninstallButton.Location = '15,315'
